...
class ProductListItem extends Component {
  render() {
    const compactMode = this.props.compactMode !== false;
    return(<div className={compactMode ? "product-item-compact" : "product-item"}>
      ...
      <div className="product-item-info">
        ...
        {compactMode ? "" : <span className="product-item-price">R$ {this.props.price === undefined ? '0,0' : this.props.price.toFixed(2).replace('.', ',')}</span>}
      </div>
    </div>);
  }
}
