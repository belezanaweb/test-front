...
class Confirmation extends Component {
      ...
      <main>
        <div className="container">
          <nav className="nav-products">
            ...
            <Link to="/payment" className="col-xs-4">
              Pagamento
            </Link>
            <Link to="/confirmation" className="active col-xs-4">
              Confirmação
            </Link>
          ...
          <div className="confirmation-box">
            <i className="fa fa-check-circle-o confirmation-icon" aria-hidden="true" />
  ...
  renderProductList() {
    return this.props.items.map((item, i) => <ProductResume key={i} product={item.product} />)
  }
}
