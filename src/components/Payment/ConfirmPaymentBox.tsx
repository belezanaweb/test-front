...
export const ConfirmPaymentBox = () => {
  ...
  return (
    <div className="flex flex-col  text-center items-center bg-white rounded border border-[#CCC] px-2 py-6">
      <h1 className="text-[22px]">Compra efetuada com sucesso</h1>
