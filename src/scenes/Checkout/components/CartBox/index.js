...
import Block, {ListItem, ListFigure, ListDescription} from '../Block';
    ...
    return(
        <Container>
            <ListItem className={this.props.condensed?"condensed":""}>
                ...
                <ListDescription showPrice={this.props.condensed?false:true} text="L'Oréal Professionnel Expert Absolut Repair Cortex Lipidium" price="R$ 225,90"/>
            </ListItem>
            ...
            <ListItem className={this.props.condensed?"condensed":""}>
                ...
                <ListDescription  showPrice={this.props.condensed?false:true} text="Good Girl Carolina Herrera Eau de Parfum - Perfume Feminino 30ml" price="R$ 299,00"/>
            </ListItem>
            ...
            <ListItem className={this.props.condensed?"condensed":""}>
                ...
                <ListDescription  showPrice={this.props.condensed?false:true} text="Senscience Inner Restore Intensif - Máscara Capilar 50ml" price="R$ 99,90"/>
            </ListItem>
        </Container>
    );
  }
