...
describe('App', () => {
  ...
  it('renders info page', async () => {
    // check if the page is loaded after the data is loaded
    expect(
      await findByText(
        container,
    ...
    // check if the page is loaded with the correct value product
    expect(await findByText(container, 'R$ 624,80')).toBeVisible()
    // check if the page is loaded with the correct value total
